        ...
        <div className=" bg-[#111111] text-[#F9F9F9]">
            <div className="flex gap-4 w-10/12 mx-auto py-10 text-[18px]">
                <div className="flex-1">
                    <h2 className="text-4xl font-bold mb-8">CarHub.</h2>
                ...
                <div className="flex-1 flex justify-center gap-4">
                    <div>
                        ...
                        <ul className="mt-7">
                            ...
                            <li className="mb-5"><a href="*">Update News</a></li>
                            <li className="mb-5">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold mb-7">Support Center</h3>
                        <hr />
                        <ul className="mt-7">
                            <li className="mb-5">
                                <a href="*">FAQ's</a>
                ...
                <div className="flex-1">
                    ...
                    <input className="mb-7 py-3 px-4 rounded" placeholder="Your Email" type="text" />
                    <br />
                    <button className="btn py-3 px-12">SubsCribe Now <i className="text-2xl"><BiLogoTelegram/></i> </button>
                </div>
            </div>
        </div>
    );
